    ...
    def update 
        ...
        respond_to do |format| 
          ActiveRecord::Base.transaction do 
            ...
            format.turbo_stream { 
              render turbo_stream: turbo_stream.replace("connection-status-#{@connection.id}", partial: 'connections/update', locals: { connection: @connection }) 
            }
          rescue StandardError => e
            format.turbo_stream { render turbo_stream: turbo_stream.replace("connection-status-#{@connection.id}", partial: 'connections/error', locals: { error_message: e.message }) }
